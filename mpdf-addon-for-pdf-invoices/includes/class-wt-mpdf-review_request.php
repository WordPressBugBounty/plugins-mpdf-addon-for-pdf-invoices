...
class Wt_Pklist_Mpdf_Review_Request
{
    /**
     * config options 
     */
    private $plugin_title               =   "mPDF add-on for PDF Invoices, Packing Slips, Delivery Notes & Shipping Labels";
    private $review_url                 =   "https://wordpress.org/support/plugin/mpdf-addon-for-pdf-invoices/reviews/#new-post";
    private $plugin_prefix              =   "wt_mpdf"; /* must be unique name */
    ...
    public function __construct()
    {
        ...
        register_activation_hook(WT_PKLIST_MPDF_PLUGIN_FILENAME , array($this, 'on_activate'));
    ...
    public function set_vars()
    {
        ...
        $this->webtoffee_logo_url           =    WT_PKLIST_MPDF_PLUGIN_URL . 'assets/images/webtoffee-logo_small.png';
...
new Wt_Pklist_Mpdf_Review_Request();
